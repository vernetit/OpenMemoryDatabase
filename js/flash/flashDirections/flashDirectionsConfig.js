...
function config(){
	...
	selectedConfig=`
		name : <input type="text" value="${nombre}" id="nombre">  directionsByFlash: <input type="number" value="${cartasByFlash}" id="cartasByFlash"> <br>
		numberOfDirections : <input type="number" value="${total}" id="numberOfCards"> <!-- inicialTime: <input type="number" value="${tiempoInicial}" id="tiempoInicial"> -->  
...
function newConfig(){
	...
	selectedConfig=`
		name : <input type="text" value="${nombre}" id="nombre">  directionsByFigures: <input type="number" value="${cartasByFlash}" id="cartasByFlash"> <br>
		numberOfDirections : <input type="number" value="${total}" id="numberOfCards"> <!-- inicialTime: <input type="number" value="${tiempoInicial}" id="tiempoInicial"> --> 
		BlankTime: <input type="number" value="${blankTime}" id="blankTime"> 
		<br>
		putSuggestedVelocities:
...
function save(){
	...
	if(cartasByFlash<1 || cartasByFlash>3){
		msj+="\nQuantity of directions per flash most be in values (1 to 3)."
		bError=1;
	}

	if(total<1 || total>72){
		msj+="\nTotal Directions most be in values (1 to 72)."
		bError=1;
	}
...
*/
	...
	configApp=poner;
	localStorage.setItem("configAppLocalStorageD", configApp);
...
$(document).keypress(function(event) {
	...
	if (event.charCode==100){
		...
		localStorage.removeItem('configAppLocalStorageD');
		window.location.href= "/flashDirections";
	}
