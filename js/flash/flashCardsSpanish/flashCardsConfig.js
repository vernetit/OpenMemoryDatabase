...
function save(){
	...
	if(total<1 || total>48){
		msj+="\nTotal cards most be in values (1 to 48)."
		bError=1;
	}
...
*/
	...
	configApp=poner;
	localStorage.setItem("configAppLocalStorageFCEs", configApp);
...
$(document).keypress(function(event) {
	...
	if (event.charCode==100){
		...
		localStorage.removeItem('configAppLocalStorageFCEs');
		window.location.href= "/flashCardsSpanish";
	}
