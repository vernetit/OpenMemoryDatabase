...
function init(x){
  ...
  _contador=contador;
  if(bHideNumber) _contador="<br>";

  $("#screen").html(`<center><h3>${_contador}</h3><br><img src="${rootDir}${arrayImages[contador-1]}" class="myImage"></center>`);
      ...
      if(_a[j]==null){
        ...
        _p+=`<td>
          ...
          <center>  
            ...
            <div id="c-${_x}"></div>
            <div id="c1-${_x}">
              <img src="${rootDir}${_a[j]}" width="76" height="76"  onclick="if($(this).css('zoom')==1) $(this).css('zoom',2.5); else $(this).css('zoom',1);">
              <span class="hideAll">  
                <br>
...
function answer(){
  ...
  //   }else{
  //     $("#r-"+i).css("border","2px solid red")
  //     $("#c1-"+i).html(`<img src="${rootDir}${arrayR[i]}" width="64" height="64"  onclick="if($(this).css('zoom')==1) $(this).css('zoom',2.5); else $(this).css('zoom',1);">`)
...
function startGame(){
  ...
  fs.readdir('images/'+fd, (err, dir) => {
    ...
    for(i=0;i<totalImages;i++){
      ...
      arrayImages2[i]=`images/${fd}/`+myFiles[x[i]];
    }
